    ...
    forecastHTML =
      ...
      <div class="col-2">
        ...
        <div class="weather-forecast-temperatures">
          ...
          <br />
          <span class="weather-forecast-temperature-humidity"> H:${Math.round(forecastDay.temperature.humidity)}% </span>
          <br />
          <span class="weather-forecast-wind"> W:${Math.round(forecastDay.wind.speed)}km/h </span>
        </div>
      </div>
  `;
    }
